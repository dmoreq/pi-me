/**
 * Usage Extension - Core Logic
 * Data collection, parsing, insights, and UI component for /usage command
 */

import type { Theme } from "@mariozechner/pi-coding-agent";
import { matchesKey, visibleWidth, truncateToWidth, wrapTextWithAnsi } from "@mariozechner/pi-tui";
