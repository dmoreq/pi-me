...
export interface MessageMetadata {
	...
	/** Tool call IDs extracted from the message (tool-pairing rule) */
	toolUseIds?: string[];
	/** Whether message contains toolCall content blocks (tool-pairing rule) */
	hasToolUse?: boolean;
	/** Whether message is a toolResult role (tool-pairing rule) */
	hasToolResult?: boolean;
	/** Whether protected by tool-pairing rule to maintain API compatibility */
