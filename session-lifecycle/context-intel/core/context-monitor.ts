 ...
 *
 * Replaces:
 *   - context-intel's ad-hoc `sessionMessageCount` + `lastRecapAt` fields
 *   - context-window's token usage tracking
 *   - context-pruning's inline stats tracking
 */

import type { TokenUsage, SessionStats } from "../types.js";
