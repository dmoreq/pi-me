...
> **Related skills:** `/skill:test-driven-development` defines the RED-GREEN-REFACTOR cycle this skill adapts to documentation.
...
description: Use when executing plans - dispatches subprocess per task with code review between tasks
...
When searching, dispatch subprocess with template...
[20 lines of repeated instructions]

# ✅ GOOD: Reference other skill
Always use subprocesss (50-100x context savings). REQUIRED: Use the relevant skill for workflow.
```
...
[Dispatch subprocess with search query: "React Router authentication error handling 401"]

# ✅ GOOD: Minimal example (20 words)
Partner: "How did we handle auth errors in React Router?"
You: Searching...
[Dispatch subprocess → synthesis]
```
...
Use the `/skill:<name>` format with explicit requirement markers:
...
**REQUIRED BACKGROUND:** `/skill:test-driven-development` explains why this matters. Same principles apply to documentation.
...
Run pressure scenario with subprocess WITHOUT the skill. Document exact behavior:
...
**Testing methodology:** See @testing-skills-with-subprocesss.md for the complete testing methodology:
